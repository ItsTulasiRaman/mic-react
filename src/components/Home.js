...
const Home = () => {
  return (
    <div className="home-background">
      <div className="grid grid-rows-[500px_200px] grid-cols-[100vw] md:grid-rows-1 md:grid-cols-[1fr_1fr_500px] lg:grid-cols-[1fr_1fr_1fr_700px] md:gap-10 items-center   w-100 h-screen ">
        ...
        <div className=" md:flex relative  items-center  ">
          ...
          <div className="max-w-sm  md:max-w-none absolute w-[70%] top-[70%] right-[10%] md:w-1/2  md:top-40 md:right-40 lg:top-[250px] right-[200px] z-10 w-1/2 ">
